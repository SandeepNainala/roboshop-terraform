...
#module "rds" {
#    source = "git::https://github.com/SandeepNainala/tf-module-rds.git"
#
#    for_each       = var.rds
#    subnets        = lookup(lookup(lookup(lookup(module.vpc, "main", null), "subnets", null), each.value["subnet_name"], null), "subnet_ids", null)
#    allow_db_cidr  = lookup(lookup(lookup(lookup(module.vpc, "main", null), "subnets", null), each.value["allow_db_cidr"], null), "subnet_cidrs", null)
...
#module "elasticache" {
#    source = "git::https://github.com/SandeepNainala/tf-module-elasticache.git"
#
...
#module "rabbitmq" {
#    source = "git::https://github.com/SandeepNainala/tf-module-amazon-mq.git"
#
...
#module "alb" {
#    source = "git::https://github.com/SandeepNainala/tf-module-alb.git"
#
#    for_each      = var.alb
#    subnets       = lookup(lookup(lookup(lookup(module.vpc, "main", null), "subnets", null), each.value["subnet_name"], null), "subnet_ids", null)
...
module "eks" {
    source             = "git::https://github.com/SandeepNainala/tf-module-eks.git"
    ENV                = var.env
    eks_version        = 1.27
